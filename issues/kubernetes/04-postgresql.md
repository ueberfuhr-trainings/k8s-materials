...
Als Entwickler möchte ich eine PostgreSQL-Datenbank in Kubernetes betreiben, deren Konfiguration sauber und sicher bereitgestellt wird, damit das Backend später auf eine echte Datenbank umgestellt werden kann.

> **Hinweis:** Diese Übung beschreibt bewusst nur das **Ziel** und die nötigen **Parameter** – nicht den Weg dorthin. Überlege selbst, mit welchen Kubernetes-Ressourcen du das umsetzt.

## 🎯 Lernziele

* Du kannst eine Datenbank als Workload in Kubernetes betreiben.
